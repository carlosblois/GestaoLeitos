...
namespace Operacional.API.Utilitarios
{
    ...
    public class Util
    {
        ...
        internal static async Task<EncaminharOut> Encaminhar(string ConfiguracaoURL, string tokenURL, int idUsuario, int idEmpresa, AtividadeItem atividadeToOrigemEncaminhar, List<TipoAtividade> LstTipoAtividadeToSave,int idTipoAcomodacao)
        {
        ...
        internal static AtividadeSaveIE CriaEventoAtividade(AtividadeItem atividadeToSave)
        {
